...
<html lang="en">
  <head>
    ...
    <title>Partnerships & Sponsorships</title>
    ...
    <script src="js/pages/pages-card-user-1.js" defer></script>
  ...
  <body class="is-header-blur">
    <!-- App preloader-->
    <div
      class="app-preloader fixed z-50 grid h-full w-full place-content-center bg-slate-50"
    >
    ...
    <div
      id="root"
      class="min-h-100vh cloak flex grow bg-slate-50"
    >
      <!-- Sidebar -->
      <div class="sidebar print:hidden">
          ...
          >
            ...
            >
              ...
              <a
                ...
                class="tooltip-main-sidebar flex size-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25"
              >
                <svg
                  class="size-7"
              ...
              <a
                ...
                class="tooltip-main-sidebar flex size-11 items-center justify-center rounded-lg bg-primary/10 text-primary outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25"
            ...
            <div class="flex flex-col items-center space-y-3 py-3">
              ...
              <div id="profile-wrapper" class="flex">
                <button id="profile-ref" class="avatar size-12">
                  ...
                  />
                  <span
                    class="absolute right-0 size-3.5 rounded-full border-2 border-white bg-success"
                  ></span>
                </button>
        ...
        <div class="sidebar-panel">
          <div
            class="flex h-full grow flex-col bg-white pl-[var(--main-sidebar-width)]"
          >
            ...
            >
              <p
                class="text-base tracking-wider text-slate-800"
              >
                Layouts
              </p>
              <button
                class="sidebar-close btn size-7 rounded-full p-0 text-primary hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 xl:hidden"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="size-6"
            ...
            >
              <ul class="flex flex-1 flex-col px-4 font-inter">
                <li
                  class="ac nav-parent [&.is-active_svg]:rotate-90 [&.is-active_.ac-trigger]:font-semibold [&.is-active_.ac-trigger]:text-slate-800"
                >
                  <button
                    class="ac-trigger flex w-full items-center justify-between py-2 text-xs+ tracking-wide text-slate-600 outline-none transition-[color,padding-left] duration-300 ease-in-out hover:text-slate-800"
                  >
                  ...
                  <ul class="ac-panel">
                    <li>
                      <a
                        ...
                        data-default-class="text-slate-600 hover:text-slate-800"
                        data-active-class="font-medium text-primary"
                      >
      ...
      <nav class="header print:hidden">
        <!-- App Header  -->
        <div
          class="header-container relative flex w-full bg-white print:hidden"
        >
          <!-- Header Items -->
          <div class="flex w-full items-center justify-between">
            ...
            <div class="size-7">
              <button
                class="sidebar-toggle ml-0.5 flex size-7 flex-col justify-center space-y-1.5 text-primary outline-none focus:outline-none"
              >
                <span></span>
                <span></span>
                <span></span>
            ...
            <div class="-mr-1.5 flex items-center space-x-2">
              ...
              <button
                class="mobile-searchbar-show btn size-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 sm:hidden"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="size-5.5 text-slate-500"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  stroke-width="1.5"
              ...
              <div id="searchbar-wrapper" class="hidden sm:flex">
                <div class="relative mr-4 flex h-8">
                  <input
                    ...
                    class="form-input peer h-full w-60 rounded-full bg-slate-150 px-4 pl-9 text-xs+ text-slate-800 ring-primary/50 hover:bg-slate-200 focus:ring"
                    type="text"
                  />
                  <div
                  ...
                  >
                    ...
                    >
                      <button
                        ...
                        data-active-class="border-primary text-primary"
                        data-default-class="border-transparent hover:text-slate-800 focus:text-slate-800"
                    ...
                    >
                      ...
                      <div class="mt-1 font-inter font-medium">
                        <a
                          class="group flex items-center space-x-2 px-2.5 py-2 tracking-wide outline-none transition-all hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800"
                          href="apps-chat.html"
                        >
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
              ...
              <!-- Dark Mode Toggle -->
              <button
                class="darkmode-toggle btn size-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25"
              >
                <svg
              ...
              <button
                class="monochrome-toggle btn size-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25"
              >
                <i
              ...
              <div id="notification-wrapper" class="flex">
                ...
                <div id="notification-box" class="popper-root">
                  <div
                    class="notification-tab-wrapper popper-box mx-4 mt-1 flex max-h-[calc(100vh-6rem)] w-[calc(100vw-2rem)] flex-col rounded-lg border border-slate-150 bg-white shadow-soft sm:m-0 sm:w-80"
                  >
                    <div
                    ...
                    <div class="flex flex-col overflow-hidden">
                      ...
                      >
                        <div class="flex items-center space-x-3">
                          ...
                          >
                            <i
                              class="fa fa-user-edit text-secondary"
                            ></i>
                          </div>
                          <div>
                            <p
                        ...
                        <div class="flex items-center space-x-3">
                          ...
                          <div>
                            ...
                            <div
                              class="mt-1 flex text-xs text-slate-400"
                            >
                              <span class="shrink-0">08:00 - 09:00</span>
                              <div
                                class="mx-2 my-1 w-px bg-slate-200"
                              ></div>
                        ...
                        <div class="flex items-center space-x-3">
                          ...
                          >
                            <i
                              class="fa-solid fa-image text-primary"
                            ></i>
                          </div>
                          <div>
                            <p
      ...
      <div id="right-sidebar" class="drawer drawer-right">
        ...
        >
          <div
            class="right-sidebar-tab-wrapper w-ful relative flex h-full flex-col bg-white"
          >
            ...
            >
              ...
              <div class="mt-4">
                <div class="grid grid-cols-2 gap-3 px-3">
                  <div
                    class="rounded-lg bg-slate-150 px-2.5 py-2"
                  >
                    ...
                    <div
                      class="progress mt-3 h-1.5 bg-secondary/15"
                    >
                      <div
                  ...
                  >
                    ...
                    <div
                      class="progress mt-3 h-1.5 bg-success/15"
                    >
                      <div
                  ...
                  >
                    <div class="flex flex-1 flex-col justify-between">
                      <div class="line-clamp-2">
                        <a
                          href="#"
                          class="font-medium text-slate-700 hover:text-primary focus:text-primary"
              ...
              <div class="mt-3 px-3">
                <div class="rounded-lg bg-slate-100 p-3">
                  <div class="flex items-center justify-between">
                    ...
                    <a
                      href="#"
                      class="text-xs+ font-medium text-primary outline-none transition-colors duration-300 hover:text-primary/70 focus:text-primary/70"
                      >Upgrade</a
                    >
                  </div>
            ...
            >
              ...
              <div
                class="mt-4 rounded-lg border border-slate-150 p-3"
              >
                <div class="flex items-center space-x-3">
                  <img
                  ...
                  <div>
                    <p
                      class="font-medium leading-snug text-slate-700"
                    >
                      LMS App Design
                    </p>
                    <p class="text-xs text-slate-400">
                ...
                <div class="mt-4">
                  <div class="progress h-1.5 bg-slate-150">
                    <div
                      class="w-4/12 rounded-full bg-primary"
                    ></div>
                  </div>
                  <p
                    class="mt-2 text-right text-xs+ font-medium text-primary"
                  >
                    25%
                  </p>
                </div>
              ...
              >
                ...
                <div class="mt-4">
                  <div class="progress h-1.5 bg-slate-150">
                    <div
                      class="w-6/12 rounded-full bg-primary"
                    ></div>
                  </div>
                  <p
                    class="mt-2 text-right text-xs+ font-medium text-primary"
              ...
              >
                ...
                <div class="mt-4">
                  <div class="progress h-1.5 bg-slate-150">
                    <div
                      class="w-2/12 rounded-full bg-primary"
                    ></div>
                  </div>
                  <p
                    class="mt-2 text-right text-xs+ font-medium text-primary"
            ...
            >
              ...
              >
                ...
                <div
                  class="progress mt-3 h-2 bg-secondary/15"
                >
                  <div
                    class="is-active relative w-8/12 overflow-hidden rounded-full bg-secondary"
                  ></div>
            ...
            >
              ...
              >
                <button
                  ...
                  data-active-class="text-primary [&_svg:last-child]:hidden"
                  data-default-class="[&_svg:first-child]:hidden"
                  class="tab btn h-9 rounded-full py-0 px-4 hover:bg-slate-300/20 hover:text-primary focus:bg-slate-300/20 focus:text-primary active:bg-slate-300/25"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
      ...
      <main class="main-content w-full px-[var(--margin-x)] pb-8">
        <div class="flex items-center justify-between py-5 lg:py-6">
          <div class="flex items-center space-x-1">
            <h2
              class="text-xl font-medium text-slate-700 line-clamp-1 lg:text-2xl"
            >
            Partnerships & Sponsorships
            </h2>
            <div id="top-header-menu" class="inline-flex">
              <button
                class="btn popper-ref size-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25"
              >
          ...
          <div class="flex items-center space-x-2">
            ...
            <div class="flex">
              <button
                class="btn size-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 sm:hidden sm:h-9 sm:w-9"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="size-5"
              ...
              <button
                class="btn size-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 sm:h-9 sm:w-9"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="size-5"
          ...
          <div class="card">
            <div class="p-2 text-right">
              <div id="cardMenu1" class="inline-flex">
                <button
                  class="popper-ref btn size-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="size-5"
            ...
            <div class="flex grow flex-col items-center px-4 pb-5 sm:px-5">
              <div class="avatar size-20">
                <img
                  class="rounded-full"
                  src="{{ asset('images/portio-dlamini.jpg') }}"
                  alt="avatar"
                />
              </div>
              <h3
                class="pt-3 text-lg font-medium text-slate-700"
              >
                Konnor Guzman
              </h3>
              ...
              <div class="mt-6 grid w-full grid-cols-2 gap-2">
                <button
                  class="btn space-x-2 bg-primary px-0 font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <button
                  class="btn space-x-2 bg-slate-150 px-0 font-medium text-slate-800 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200/80"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="size-4 shrink-0"
          ...
          <div class="card">
            ...
            <div class="flex grow flex-col items-center px-4 pb-5 sm:px-5">
              <div class="avatar size-20">
                <img
                  class="rounded-full"
                  src="{{ asset('images/app-woman-white-solution-closeup-two.jpg') }}"
                  alt="avatar"
                />
              </div>            
              <h3
          ...
          <div class="card">
            ...
            <div class="flex grow flex-col items-center px-4 pb-5 sm:px-5">
              ...
              <div class="inline-space mt-3 flex grow flex-wrap items-start">
                <a
                  href="#"
                  class="tag rounded-full bg-secondary/10 text-secondary hover:bg-secondary/20 focus:bg-secondary/20 active:bg-secondary/25"
                >
                  Javascript
                </a>
                <a
          ...
          <div class="card">
            ...
            <div class="flex grow flex-col items-center px-4 pb-5 sm:px-5">
              <div class="avatar size-20">
                <img
                  class="rounded-full"
                  src="{{ asset('images/img_8772_919x1240.webp') }}"
                  alt="avatar"
                />
              </div>                       
              <h3
          ...
          <div class="card">
            ...
            <div class="flex grow flex-col items-center px-4 pb-5 sm:px-5">
              <div class="avatar size-20">
                <img
                  class="rounded-full"
                  src="{{ asset('images/FAYROUZ HOLLIDAY (1).jpg') }}"
                  alt="avatar"
                />
              </div>                              
              <h3
...
<!-- Include necessary JS and CSS for Owl Carousel and Animations -->
